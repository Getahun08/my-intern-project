...
function NewpasswordCreateConfirm() {
    ...
    return (
      <div className={'background'}>
         {Showmessage? <Mymessage text={'  your password is  is created successfully '}
                severity={"success"}/>:null}
              <form onSubmit={handleSubmit(submission)}>
              
           <Box className={'whitbox'}>
                  <Box className="items">
                    <Box className="title">Create  New Password  page</Box>
                  </Box>
                  <Box className="items">
                  <Passform 
                    label='Password'
...
export default NewpasswordCreateConfirm